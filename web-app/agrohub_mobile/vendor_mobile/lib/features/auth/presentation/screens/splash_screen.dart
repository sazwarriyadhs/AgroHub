...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    // Panggil fungsi cek auth setelah delay
  ...
  Future<void> _checkAuthAndNavigate() async {
    try {
      ...
      debugPrint('🔍 SplashScreen - Token found: ${token != null ? "Yes" : "No"}');
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            /// TEXT
                            const Text(
                              "Pertanian Maju, Vendor Petanian Sejahtera,",
                                  ...
                                  children: [
                                    Stack(
                                      children: [
                                        ...
                                        Container(
                                          height: 14,
                                          width: (size.width - 56) * _progressController.value,
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(30),
                                            gradient: LinearGradient(
                                              colors: [
