                      ...
                      Positioned(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Gabung menjadi customer resmi AgroHub\nuntuk menjual produk pertanian modern',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.poppins(
                        ...
                        child: Column(
                          children: [
                            ...
                            buildInput(
                              ...
                              hint: 'Nama usaha / toko customer',
                              icon: Icons.storefront_outlined,
                            ),
                            const SizedBox(height: 18),
                            buildInput(
                              controller: _businessTypeController,
                              hint: 'Jenis usaha customer',
                            ...
                            // BUTTON
                            GestureDetector(
                              onTap: isLoading ? null : registercustomer,
                              child: Container(
                                width: double.infinity,
                                height: 64,
                                decoration: BoxDecoration(
                            ...
                            // FOOTER
                            Text(
                              'Data customer akan diverifikasi oleh tim AgroHub\nuntuk menjaga keamanan transaksi marketplace',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.poppins(
