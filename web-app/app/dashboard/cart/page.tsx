...
import { useRouter } from 'next/navigation';  // ← Perbaiki: hapus 'a'
...
// ======================================================
// MAIN CART PAGE (Dalam Dashboard)
// ======================================================
...
export default function CartPage() {
      ...
      try {
        ...
        if (response.data.success || response.data.data) {
          ...
          const formattedItems = items.map((item: any) => ({
            ...
            seller_name: item.seller_name || 'AgroHub Store',
  ...
  // Proceed to checkout (tetap di dalam dashboard)
